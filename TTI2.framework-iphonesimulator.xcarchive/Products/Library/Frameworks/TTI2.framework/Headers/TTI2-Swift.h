...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TTI2",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC4TTI221RAMAnimatedTabBarItem")
...
@interface RAMAnimatedTabBarItem (SWIFT_EXTENSION(TTI2))
/// The current badge value
@property (nonatomic, copy) NSString * _Nullable badgeValue;
@end


SWIFT_CLASS("_TtC4TTI28RAMBadge")
...
SWIFT_CLASS("_TtC4TTI216RAMItemAnimation")
...
@property (nonatomic, strong) IBInspectable UIColor * _Nonnull textSelectedColor;
/// The icon color in selected state.
@property (nonatomic, strong) IBInspectable UIColor * _Null_unspecified iconSelectedColor;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


/// The RAMBounceAnimation class provides bounce animation.
SWIFT_CLASS("_TtC4TTI218RAMBounceAnimation")
...
/// Transition animtion
SWIFT_CLASS("_TtC4TTI227RAMTransitionItemAnimations")
...
SWIFT_CLASS("_TtC4TTI237RAMFlipBottomTransitionItemAnimations")
@interface RAMFlipBottomTransitionItemAnimations : RAMTransitionItemAnimations
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC4TTI235RAMFlipLeftTransitionItemAnimations")
@interface RAMFlipLeftTransitionItemAnimations : RAMTransitionItemAnimations
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC4TTI236RAMFlipRightTransitionItemAnimations")
@interface RAMFlipRightTransitionItemAnimations : RAMTransitionItemAnimations
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC4TTI234RAMFlipTopTransitionItemAnimations")
@interface RAMFlipTopTransitionItemAnimations : RAMTransitionItemAnimations
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


/// The RAMFrameItemAnimation class provides keyframe animation.
SWIFT_CLASS("_TtC4TTI221RAMFrameItemAnimation")
...
@property (nonatomic) IBInspectable BOOL isDeselectAnimation;
/// path to array of image names from plist file
@property (nonatomic, copy) IBInspectable NSString * _Null_unspecified imagesPath;
- (void)awakeFromNib;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC4TTI216RAMFumeAnimation")
...
SWIFT_CLASS("_TtC4TTI220RAMRotationAnimation")
...
SWIFT_CLASS("_TtC4TTI224RAMLeftRotationAnimation")
...
SWIFT_CLASS("_TtC4TTI225RAMRightRotationAnimation")
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC4TTI225SkyFloatingLabelTextField")
...
SWIFT_CLASS("_TtC4TTI219TTIRuntimeException")
@interface TTIRuntimeException : NSError
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
